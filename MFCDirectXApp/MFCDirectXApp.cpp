...
// MFCDirectXApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCDirectXAppApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCDirectXAppApp

CMFCDirectXAppApp::CMFCDirectXAppApp()
{
...
// Единственный объект CMFCDirectXAppApp

CMFCDirectXAppApp theApp;


// Инициализация CMFCDirectXAppApp

BOOL CMFCDirectXAppApp::InitInstance()
{
